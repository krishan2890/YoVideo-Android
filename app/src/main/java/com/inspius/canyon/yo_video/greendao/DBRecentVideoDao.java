...
public class DBRecentVideoDao extends AbstractDao<DBRecentVideo, Long> {
    ...
    /**
     * Properties of entity DBRecentVideo.<br/>
    ...
    */
    ...
    public DBRecentVideoDao(DaoConfig config) {
        super(config);
    }
    
    public DBRecentVideoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DBRECENT_VIDEO\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"DBRECENT_VIDEO\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, DBRecentVideo entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public DBRecentVideo readEntity(Cursor cursor, int offset) {
        DBRecentVideo entity = new DBRecentVideo( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, DBRecentVideo entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(DBRecentVideo entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(DBRecentVideo entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
