...
public class MNewsLatestPageFragment extends BaseMainFragment implements AdapterActionListener {
    public static final String TAG = MNewsLatestPageFragment.class.getSimpleName();
